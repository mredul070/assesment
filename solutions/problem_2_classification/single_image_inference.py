...
def get_class_name(label_number):
    """This function returns class name based on the input

    Args:
        label_number (int): the predicted label of the model

    Returns:
        string: the class name of the corresponding input
    """    
    if label_number == 0: return "berry"
    elif label_number == 1: return "bird"
    elif label_number == 2: return "dog"
    elif label_number == 3: return "flower"
